...
function RatingList({ title, refreshKey = 0, combinedList: externalList, users: externalUsers }) {
  ...
  }, [refreshKey, externalList]);

  const dataToShow = externalList !== undefined ? externalList : ratingData;
